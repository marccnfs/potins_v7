...
const SEARCH_API = 'http://127.0.0.1:8000/ajx/method/find/searchressources'


export function SearchRessources ({ defaultValue, onChangeRessource,cat}) {
    ...
    const suggest = useCallback(
        debounce(async e => {
            await fetch(`${SEARCH_API}?q=${encodeURI(e.target.value)}&cat=${encodeURI(cat)}`)
    ...
    const handleselect=(r,e) =>{
        ...
        setQuery("")
        onChangeRessource(r)
        window.location.href = 'show-ressource/'+r.url
    }
