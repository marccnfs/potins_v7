...
'nodes': [
  {
    ...
    'apiKey': 'vbLqFqfWJ0gImHq7KO3TqnzSRfzQT6i5EpX13HG0mMghSOdc',
...
const searchParameters={
  'q' : "",
  'page' : 1,
  'query_by' : 'title,category,content, adresses'
}
 ...
 * @return {Promise<Object>}
 */
export async function typesenseFetch (params) {

  console.log(params)
  console.log(typesense)

  searchParameters.q=params
  console.log(searchParameters)

  const response = await typesense.collections('website').documents().search(searchParameters)
