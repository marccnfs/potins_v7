$(document).ready(function() {
    ...
    let  routeaddiframe = '/admin/add-iframe-ajx',
    ...
    tabfield.iframevideo.on('change', function () {
        if (tabfield.iframevideo.val()) {
            propp(true)
        }
    });
    ...
    let startloadernews = function () {
        let fd = new FormData();
        fd.append('iframevideo', tabfield.iframevideo.val());
        fd.append('post', post);
