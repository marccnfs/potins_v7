...
$e=$ef;
        return new Passport(
            ...
            [
                new CsrfTokenBadge('authenticate', $submittedToken),
    ...
    public function onAuthenticationFailure(Request $request, AuthenticationException $exception): Response
    {
        ...
        if ($previous instanceof UserNotFoundException && $request->hasSession()) {
            $request->getSession()->getFlashBag()->add(
                'security',
                $this->translator->trans('login.unknown_email', [], 'security')
            );
        }
