...
namespace App\Infrastructure\ChabotIA\EventSubscriber;

use App\Event\ContentCreatedEvent;
use App\Event\ContentDeletedEvent;
use App\Event\ContentUpdatedEvent;
...
class IndexerSubscriber implements EventSubscriberInterface
{
    ...
    {
        /** @var array{id: string, title: string, content: string, created_at: int, tag: string[]} $content */
