...
#[ORM\Entity(repositoryClass: GpRessourcesRepository::class)]
#[ORM\Table(name:'aff_Gpressources')]
...
class GpRessources
{
    ...
    #[ORM\ManyToMany(targetEntity: Ressources::class, inversedBy: 'gpressources')]
    ...
    public function setPublied(bool $publied): GpRessources
    {
    ...
    public function addArticle(Ressources $article): self
    {
    ...
    public function removeArticle(Ressources $article): self
    {
        if ($this->articles->contains($article)) {
