...
#[ORM\Entity]
#[ORM\Table(name:"aff_tabreadprivate")]
class TbmsgD
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: MsgsD::class, inversedBy: 'tabreaders')]
    #[ORM\JoinColumn(nullable: true)]
    private ?MsgsD $idmessage= null;
    ...
    public function getIdmessage(): ?MsgsD
    {
        return $this->idmessage;
    }

    public function setIdmessage(?MsgsD $idmessage): self
    {
