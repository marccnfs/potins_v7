...
#[ORM\Entity(repositoryClass: TbmsgsRepository::class)]
...
class Tbmsgs
{
    ...
    #[ORM\ManyToOne(targetEntity: Msgs::class, inversedBy: 'tabreaders')]
    #[ORM\JoinColumn(nullable: true)]
    private ?Msgs $idmessage= null;
    ...
    #[ORM\Column(type: Types::BOOLEAN)]
    private ?bool $conversremoved = false;
    ...
    public function isConversremoved(): ?bool
    {
        return $this->conversremoved;
    }
