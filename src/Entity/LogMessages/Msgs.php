...
class Msgs
{
    ...
    #[ORM\ManyToOne(targetEntity: MsgBoard::class, inversedBy: 'msgs')]
    #[ORM\JoinColumn(nullable: true)]
    private ?MsgBoard $msgboard= null;
    ...
    #[ORM\OneToMany(targetEntity: Tbmsgs::class, mappedBy: 'idmessage', cascade: ['persist', 'remove'])]
    ...
    public function addTabreader(Tbmsgs $tabreader): self
    {
    ...
    public function removeTabreader(Tbmsgs $tabreader): self
    {
    ...
    public function getMsgboard(): ?MsgBoard
    {
        return $this->msgboard;
    }

    public function setMsgboard(?MsgBoard $msgboard): self
    {
