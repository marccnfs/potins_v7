...
/**
 * @extends ServiceEntityRepository<Wbcustomers>
 *
...
class WbcustomersRepository extends ServiceEntityRepository
{
    ...
    public function save(Wbcustomers $entity, bool $flush = false): void
    {
    ...
    public function remove(Wbcustomers $entity, bool $flush = false): void
    {
