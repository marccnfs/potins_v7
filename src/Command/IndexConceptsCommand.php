...
// src/Command/IndexConceptsCommand.php
...
#[AsCommand(name: 'app:index-concepts')]
class IndexConceptsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $filePath = __DIR__ . '/concepts.json';
        ...
        try {
            ...
            $io->progressFinish();
            $io->success('Les concepts ont bien été indexés');
