...
class ArCdnController extends AbstractController
{
    ...
    private function renderAr(string $directory, string $twig,int $switch): Response
    {
        ...
        if($switch==0){
            return $this->render( "pwa/ar/ar_cdn/".$twig.".html.twig");
        }
        else {
