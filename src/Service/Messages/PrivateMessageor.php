...
class PrivateMessageor //todo completement
{
    ...
    private $mesrepo;
    private ActivMemberRepository $dispatchSpaceWebRepository;
    private PrivateConversRepository $msgPrivateRepository;


    public function __construct( ActivMemberRepository $dispatchSpaceWebRepository, PrivateConversRepository $privateConversRepository, EntityManagerInterface $entityManager, TbmsgsRepository $tbmsgsRepository, Canonicalizer $emailCanonicalizer, Mailator $mailator)
    {
    ...
    public function sortmessage($pagination, Activmember $dispatch): array
    {
    ...
    public function addTabExpeAndDest(Offres $offre, Msgs $msg, $client){

            $tabexpe = new Tbmsgs();
            $tabexpe->setMember($client);
    ...
    public function addTabPrivateExpeAndDest($exp, Msgs $msg, $dest){
        ...
        $tabexpe = new Tbmsgs();
        $tabexpe->setIdmember($exp);
        $tabexpe->setIsRead(true);
        $tabexpe->setReadAt(new dateTime());
        $msg->addTabreader($tabexpe);
        $tabDest = new Tbmsgs();
        $tabDest->setIdmember($dest);
        $tabDest->setIsRead(true);
        $tabDest->setReadAt(new dateTime());
        $msg->addTabreader($tabexpe);
