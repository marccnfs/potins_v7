...
class FilMessageor
{
     ...
     * @return array
     */
    public function tabSpw(Board $website): array
     ...
     * @return bool
     */
    public function isTheClient(Board $website, DispatchSpaceWeb $dispatch): bool
    {
        /** @var membersboard $reader */
        foreach ($website->getSpwsites() as $reader) {
     ...
     * @throws Exception
     */
    public function newMessageFil($data): MsgBoard
    {
